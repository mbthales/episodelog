...
export default function FollowedShowCard({ show, isPressed, isActive, onLongPress, onPressStart, onPressEnd, onUnfollow }: FollowedShowCardProps) {
  ...
  return (
    <div className='max-w-[160px] relative'>
      <img src={show.poster || ''} alt={show.name} {...bind()} className={`transition-transform duration-200 ${isActive ? 'scale-90' : 'scale-100'}`}/>
      <button 
